...
import { QUILL_MODULES } from "../../constants/quillModule";
import { useEffect, useMemo, useRef, useState } from "react";
import { useInput, useMaxSizeValidateInput } from "../../hooks/inputHook";
import { useQuill, useQuillInput } from "../../hooks/quillHook";
...
function BoardWrite() {
    ...
    const [ quillValue, handeQuillValueChange ] = useQuillInput();
    ...
    return (
        <div css={layout}>
            ...
            <ReactQuill
                ...
                onChange={handeQuillValueChange}
            />
